...
from PyQt5.QtWidgets import (
    ...
    QComboBox, QMessageBox, QDateTimeEdit, QCheckBox, QListWidget, QAbstractItemView
)
```
...
ZABBIX_INSTANCES = {
    "Zabbix Teste": {
        "url": "http://ambiente_teste/zabbix/api_jsonrpc.php",
        "username": "Admin",
        "password": "zabbix"
    },
    "Zabbix de homolgacao": {
        "url": "http://ambiente_homologacao/zabbix/api_jsonrpc.php",
        "username": "Admin",
        "password": "zabbix"
    },
    "Zabbix Produção": {
        "url": "http://anbiente_principal/api_jsonrpc.php",
        "username": "Admin",
        "password": "zabbix"
    }
}
...
##  Classe ZabbixApp (Interface com PyQt5)
...
self.layout.addWidget(QLabel("Selecione o Zabbix:", self))
...
## Função para autenticar na instância selecionada 
...
## Função para buscar a lista de hosts da instância selecionada
...
## Função para filtrar os hosts na lista com base no texto digitado
...
## Adicionar um blackout na instância selecionada
